...
import id.co.myproject.ticketpay.ViewHolder.FilmInComingAdapter;

/**
 * A simple {@link Fragment} subclass.
 */
public class IncomingFilmFragment extends Fragment {
...
//    FirebaseRecyclerAdapter<Film, FilmCategoryViewHolder> adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = reference.orderByChild("status").equalTo("akan datang");
...
//                .setQuery(reference.orderByChild("status").equalTo("akan datang"), Film.class)
//                .build();
